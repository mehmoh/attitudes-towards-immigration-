def load_and_process(a):
    ...
    df1= (df1.assign(age=lambda x:2019-x['cps19_yob']-1919)
          ...
          .assign(cps19_religion= lambda x: x['cps19_religion'].map({1: 'Atheist', 2: 'Agnostic', 3: 'Buddhist', 4: 'Hindu', 5: 'Jewish', 6:'Muslim',7:'Sikh', 8:'Anglican', 9:'Baptist', 10: 'Catholic',11:'Orthodox', 12:'Jehovahs Witness', 13:'Lutheran', 14:'Church of Jesus', 15:'Pentecostal', 16:'Presbyterian', 17:'Protestant', 18:'United Church of Canada', 19:'Christian Reformed', 20:'Salvation Army', 21:'Mennonite', 22:'Other'}))
